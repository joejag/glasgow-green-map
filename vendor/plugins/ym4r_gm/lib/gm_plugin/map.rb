  ...
  module GmPlugin 
    ...
    class GMap
      ...
      def self.header(options = {})
        ...
        a = "<script src=\"http://maps.google.co.uk/maps?file=api&amp;v=2.81&amp;key=#{api_key}&amp;hl=#{options[:hl]}\" type=\"text/javascript\"></script>\n"
      ...
      def center_zoom_on_points_init(points)
        logger.info("At zoom and center")
        if(points.length > 0)
